      ...
      <div className="home">
        <div className="home__frame">
          <div className="home__introduction">
            ...
            <p className="home__shortDescription">
              "As a dedicated and <span className="passionate">passionate</span>{" "}
              junior developer, I bring a{" "}
              <span className="creative">creative touch </span>to front-end
              development, crafting engaging and dynamic websites and web
              applications with <span className="commitment">commitment</span>{" "}
              and <span className="freshIdeas">fresh ideas</span>."
            </p>
          </div>
        </div>
